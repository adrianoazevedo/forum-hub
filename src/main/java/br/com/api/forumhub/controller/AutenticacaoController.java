...
public class AutenticacaoController {
    ...
    @PostMapping
    @Operation(summary = "Realizar Login", description = "Gera um Token JWT enviado junto com as demais requisições da API. Token JWT se responsabiliza por autenticar as requisições.")
